...
class _BotCommands:
    def __init__(self):
        ...
        self.CloneCommand = [f'clone{CMD_SUFFIX}', f'clone{CMD_SUFFIX}']
        self.CountCommand = f'count{CMD_SUFFIX}'
        self.DeleteCommand = f'del{CMD_SUFFIX}'
        self.CancelMirror = f'cancel{CMD_SUFFIX}'
        self.CancelAllCommand = [f'cancelall{CMD_SUFFIX}', f'cancelall{CMD_SUFFIX}']
        self.ListCommand = f'list{CMD_SUFFIX}'
        self.SearchCommand = f'search{CMD_SUFFIX}'
        self.StatusCommand = [f'status{CMD_SUFFIX}', f'status{CMD_SUFFIX}']
